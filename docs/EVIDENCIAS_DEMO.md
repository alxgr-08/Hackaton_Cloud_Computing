...
- [ ] Carga de `frontend/public/test-becas-30.csv`.
- [ ] Respuesta 200 de API Gateway y conteo de 30 postulaciones encoladas.
- [ ] Trigger SQS de la Lambda IA: lote 25, ventana 5 segundos y concurrencia 5.
